...
A second method is to allow a participating organization, when they want to, to assign a primary and secondary/alternate member to participate. Partiicpation by either would be allowed.
