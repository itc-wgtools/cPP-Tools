...
For a multi-line selection, the end of the URL should look like *#L12-L15* to select lines 12-15 in the document.
...
To view the changes, you need to look at either the Commits or the Files Changed views. 
...
=== Adding Comments into Pull Requests
...
To do this type of comment, first you need to review the